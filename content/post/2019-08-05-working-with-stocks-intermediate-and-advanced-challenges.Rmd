...
This is a continuation of my work on the [codeacademy data science independant project #1: Watching the Stock Market](https://discuss.codecademy.com/t/data-science-independent-project-1-watching-the-stock-market/419943). 
...
1. In addition to the built-in aggregate functions, explore ways to calculate other key statistics about the data, such as the median or variance.
    * Hint: See [here](https://stackoverflow.com/questions/15763965/how-can-i-calculate-the-median-of-values-in-sqlite/15766121#15766121) and [here](https://stackoverflow.com/questions/2298339/standard-deviation-for-sqlite/4621268#4621268) for possible solutions.
